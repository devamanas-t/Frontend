      ...
      <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-slate-50 font-sans text-slate-600">
        ...
        >
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs uppercase"><span className="bg-white/80 px-2 text-slate-400 backdrop-blur-sm rounded">Or continue with</span></div>
          </div>

          <motion.button whileHover={{ scale: 1.02, backgroundColor: "#ffffff" }} whileTap={{ scale: 0.98 }} className="w-full bg-white/60 border border-slate-200 text-slate-700 py-3 rounded-xl font-semibold flex items-center justify-center gap-3 hover:shadow-md transition-all">
            <GoogleIcon />
            <span>Google</span>
          </motion.button>

          <p className="text-center mt-8 text-sm text-slate-500">
            Don't have an account? <Link to="/signup" className="font-bold text-teal-600 hover:underline">Create Free Account</Link>
          </p>
        </motion.div>
      </div>
    </>

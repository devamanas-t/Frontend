    ...
    const fetchExamStats = async () => {
      try {
        const response = await fetch(
          `http://10.160.195.16:8000/api/v1/exams/${exam_id}/stats`
        );
      ...
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex gap-3">
            <button className="flex items-center gap-2 px-4 py-2 bg-slate-800 border border-slate-700 text-slate-300 rounded-lg hover:bg-slate-700/50 transition-all font-semibold shadow-md shadow-slate-950">
              <RefreshCw size={18} /> Re-Evaluate
            </button>
            <button className="flex items-center gap-2 px-4 py-2 bg-cyan-600 text-white rounded-lg hover:bg-cyan-500 transition-all font-bold shadow-lg shadow-cyan-900">
